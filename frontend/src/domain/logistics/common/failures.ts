    ...
    INBOUND_COMPLETED: [
        {
            ...
            receiveNodeKey: 'stock-apply-confirm',
            recoverable: true,
            resumePolicy: 'retry_current_stage',
            summary: '재고 반영 최종 확정 중 오류가 발생했습니다.',
            actions: [
                { id: 'retry_confirm', label: '재고 반영 재시도', nextStage: 'INBOUND_COMPLETED', nextReceiveNodeKey: 'stock-apply-confirm' },
            ],
        },
        {
            ...
            type: 'external',
            stage: 'INBOUND_COMPLETED',
            receiveNodeKey: 'eos-close-handoff',
            recoverable: true,
            resumePolicy: 'retry_current_stage',
            summary: 'EOS 측 입고 완결 통보가 실패했습니다.',
            actions: [
                { id: 'retry_handoff', label: 'EOS 재통보', nextStage: 'INBOUND_COMPLETED', nextReceiveNodeKey: 'eos-close-handoff' },
