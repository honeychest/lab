// [AGENT] 역할: 5분봉 집계 엔티티 (agg_trade_5m 테이블) | 연관파일: AggTrade5mRepository.java, AggTradeRollupService.java
...
@Table(
    ...
    uniqueConstraints = @UniqueConstraint(
        name = "uq_agg_trade_5m",
        columnNames = {"symbol", "market_type", "candle_time_ms"}
    ),
    indexes = {
        @Index(name = "idx_5m_symbol_candle_time", columnList = "symbol, candle_time_ms")
    }
)
public class AggTrade5m {
